...
import 'package:myapp/language_helper/languages.dart';
...
class TheInfoDrawerState extends State<TheInfoDrawer> {
  ...
  void initState() {
    super.initState();
    _selectedLanguage = PuttingDrillApp.of(context)!.currentLocale.toString();
          ...
          Padding(
            ...
            child: DropdownButton<String>(
              ...
              items: [
                ...
                DropdownMenuItem(
                  value: Language.dutch.languageKey,
                  child: Row(
                    children: <Widget>[
                      LanguageFlag(
                        countryCode: Language.dutch.flagKey,
                      ),
                      spaceBetween,
                      Text(Language.dutch.nameKey),
                    ],
                  ),
                ),
                DropdownMenuItem(
